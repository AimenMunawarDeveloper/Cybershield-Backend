...
const { getCourses, getCourseById, createCourse, updateCourse, deleteCourse, getProgress, getActivityEmailStatus, markComplete, unmarkComplete, sendActivityEmail, sendActivityWhatsApp } = require("../controllers/courseController");
